              ...
              <CardContent className="flex flex-col items-center justify-center text-center">
                ...
                <p className="text-muted-foreground mb-4">
                  {searchTerm || statusFilter !== 'all' 
                    ...
                    : "Create your first produce request to connect with farmers"
                  }
                </p>
                <Link href="/dashboard/buyer/requests/new">
                  <Button>
    ...
    <Card>
      ...
      <CardContent>
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <div>
            <h4 className="text-sm font-medium text-muted-foreground mb-1">Delivery Location</h4>
            <p className="text-lg font-semibold">{request.deliveryLocation}</p>
          </div>
          <div>
            <h4 className="text-sm font-medium text-muted-foreground mb-1">Quality Specifications</h4>
            <p className="text-lg font-semibold">{request.qualitySpecs}</p>
          </div>
          <div>
            <h4 className="text-sm font-medium text-muted-foreground mb-1">Delivery Window</h4>
            <p className="text-lg font-semibold">
